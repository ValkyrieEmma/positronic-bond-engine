...
8. No public-claims rule specifically about safety-standard language (certified/SIL-rated/etc.) — worth adding next to AGENTS.md §4's existing marketing constraints (Section 2).
