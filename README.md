...
Ontology textbook version remains independently versioned (currently `0.3.0` in engine traces); **project package version is 0.5.0.dev0** (`version_hint=0.5.0-dev`). Voice / TTS remains out of scope. This is still experimental—not a production robot stack and not a finished software product.
